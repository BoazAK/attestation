	          ...
	          <div class="col-md-12 ftco-animate">
	          	<div class="text w-100 text-center">
		            <h1 class="mb-3">Bienvenue</h1>
	          		<h3><span class="type" style="--n:53">sur votre site de téléchargement de fiche d'attestation de vos recharges.</span></h3>
                
                <br><br><br><br><br><br>
                
                <div class="row">
                  <div class="col-6 col-md-6">
                    <a class="btn btn-success" href="attestation.php">Télécharger une fiche d'attestation</a>
                  </div>
                  <div class="col-6 col-md-6">
                    <a class="btn btn-danger" href="refund.php">Demander un remboursement</a>
                  </div>
                </div>
	            </div>
	          </div>
